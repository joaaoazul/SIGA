    ...
    <div className="bg-white rounded-xl shadow-sm p-6">
      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-2 pt-4">
          <button className="flex-1 flex items-center justify-center space-x-1 py-2 px-3 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 transition-colors text-sm font-medium" onClick={() => navigate('/athletes')}>
